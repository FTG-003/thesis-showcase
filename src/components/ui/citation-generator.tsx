...
export const CitationGenerator = () => {
  ...
  const citations = {
    apa: "Terzi, F. (2025). Cognitive Intraspecific Selection in Education: From Individualism to Collective Strength. Pyragogy Research Initiative. https://pyragogy.org",
    mla: "Terzi, Fabrizio. \"Cognitive Intraspecific Selection in Education: From Individualism to Collective Strength.\" Pyragogy Research Initiative, 2025, pyragogy.org.",
    chicago: "Terzi, Fabrizio. \"Cognitive Intraspecific Selection in Education: From Individualism to Collective Strength.\" Pyragogy Research Initiative. Accessed December 2025. https://pyragogy.org",
    ieee: "F. Terzi, \"Cognitive Intraspecific Selection in Education: From Individualism to Collective Strength,\" Pyragogy Research Initiative, 2025. [Online]. Available: https://pyragogy.org"
  };
